...
public class TransactionalConfig {
    ...
    /**
     * 自定义方法名的事务属性相关联,可以使用通配符(*)字符关联相同的事务属性的设置方法; 传播事务(默认的){@link org.springframework.transaction.annotation.Propagation#REQUIRED}
     */
    ...
    /**
     * 支持当前事务;如果不存在创建一个新的 {@link org.springframework.transaction.annotation.Propagation#REQUIRED}
     */
